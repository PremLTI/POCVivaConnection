...
class GraphService implements IGraphService {
    ...
    public async GetAllTasks(): Promise<MicrosoftGraph.PlannerTask[]> {
        let response: any = await this.GET('/me/todo/lists/"AAMkADA1ZjAyYTE2LTMzNTktNGVmMi05MTg3LTc2Y2EyZDZiYmFlMQAuAAAAAAASog_aZgwkS4XSntp6RVAzAQCQtjF7Za13RbQ7ArvnIcjnAAAAAAESAAA="/tasks', '');
        return response.value;
    }
